            ...
            ? (
              <div className="space-y-5 text-sm">
                ...
                {r.resume_tailorer.headline && (
                  <h2 className="text-lg font-semibold text-zinc-950">{r.resume_tailorer.headline}</h2>
                )}
                {r.resume_tailorer.summary && (
                  <section>
                    <h3 className="mb-1 text-xs font-semibold uppercase tracking-[0.16em] text-zinc-500">Summary</h3>
                    <p className="whitespace-pre-wrap text-zinc-700">{r.resume_tailorer.summary}</p>
                  </section>
                )}
                {(r.resume_tailorer.skills ?? []).length > 0 && (
                  <section>
                    <h3 className="mb-1 text-xs font-semibold uppercase tracking-[0.16em] text-zinc-500">Skills</h3>
                    <p className="text-zinc-700">{(r.resume_tailorer.skills ?? []).join(", ")}</p>
                  </section>
                )}
                {(r.resume_tailorer.experience ?? []).length > 0 && (
                  <section className="space-y-3">
                    <h3 className="text-xs font-semibold text-zinc-500 uppercase">Experience</h3>
                    {(r.resume_tailorer.experience ?? []).map((item, i) => (
                      <div key={i} className="space-y-1">
                        ...
                        <ul className="space-y-1 pl-5 text-zinc-700 list-disc">
                ...
                {(r.resume_tailorer.tailored_bullets ?? []).length > 0 && (
                  <section className="space-y-3">
                    <h3 className="text-xs font-semibold text-zinc-500 uppercase">Bullet Rewrites</h3>
