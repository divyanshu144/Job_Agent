        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full rounded-xl border border-zinc-200 bg-white px-3 py-2.5 font-mono text-sm shadow-sm shadow-zinc-100 focus:outline-none focus:ring-2 focus:ring-blue-600/20"
